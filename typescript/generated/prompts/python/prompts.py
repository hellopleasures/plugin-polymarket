...
CHECK_ORDER_SCORING_TEMPLATE = """extract one or more order IDs for checking their scoring status.
...
GET_ACCOUNT_ACCESS_STATUS_TEMPLATE = """confirm if the user wants to check their Polymarket account access status, such as U.S. certification requirements.
...
GET_ACTIVE_ORDERS_TEMPLATE = """extract parameters for retrieving active orders for a specific market.
...
GET_BEST_PRICE_TEMPLATE = """extract token ID and side parameters for retrieving the best price for a market.
...
GET_MARKET_TEMPLATE = """extract market identification parameters from the user's message.
...
GET_MIDPOINT_PRICE_TEMPLATE = """extract token identification parameters for retrieving midpoint price data.
...
GET_ORDER_BOOK_DEPTH_TEMPLATE = """extract token identification parameters for retrieving order book depth data.
...
GET_ORDER_BOOK_TEMPLATE = """extract token identification parameters for retrieving order book data.
...
GET_ORDER_DETAILS_TEMPLATE = """extract the order ID for retrieving order details.
...
GET_SAMPLING_MARKETS_TEMPLATE = """extract optional pagination parameters for retrieving Polymarket markets with rewards enabled (sampling markets).
...
GET_SIMPLIFIED_MARKETS_TEMPLATE = """extract optional pagination parameters for retrieving simplified Polymarket markets.
...
GET_SPREAD_TEMPLATE = """extract token identification parameters for retrieving spread data for a market.
...
GET_TRADE_HISTORY_TEMPLATE = """extract parameters for retrieving a user's trade history.
...
ORDER_TEMPLATE = """extract order parameters from the user's message.
...
RESEARCH_MARKET_TEMPLATE = """extract parameters for researching a Polymarket prediction market.
...
RETRIEVE_ALL_MARKETS_TEMPLATE = """extract optional filter parameters for retrieving Polymarket prediction markets.
...
Based on the conversation, identify any filters or view modes the user wants to apply:
...
- sampling: Whether the user wants a random sample or sampling rewards (true/false) - optional
