...
export const orderTemplate = `extract order parameters from the user's message.
...
export const retrieveAllMarketsTemplate = `extract optional filter parameters for retrieving Polymarket prediction markets.
