...
pub const ORDER_TEMPLATE: &str = r#"extract order parameters from the user's message.
...
pub const RETRIEVE_ALL_MARKETS_TEMPLATE: &str = r#"extract optional filter parameters for retrieving Polymarket prediction markets.
